...
export class AppointmentComponent implements OnInit {
    ...
    this.route.params.subscribe(params => {
      ...
      this.appointmentService.getAppointments()
        .subscribe((data: any[]) => {
          ...
          if (appointment && appointment.operatingDays && appointment.operatingDays[0] && appointment.operatingDays[0][1]) {
            this.appointmentTimeslots = appointment.operatingDays[0][1].timeslot;
            console.log('this.appointmentTimeslots',this.appointmentTimeslots)
          } else {
  ...
  populateAppointmentDates() {
    ...
    while (today <= next15Days) {
      ...
      console.log("next15Days", this.appointmentDates)
